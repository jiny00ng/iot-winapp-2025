namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        {
            if (CboFonts.SelectedIndex < 0) return;  // 폰트를 아무것도 선택 안한 경우

            FontStyle style = FontStyle.Regular; // 0 대신에 Regular

            if (ChkBold.Checked) style |= FontStyle.Bold;  // FontSytle.Regular | FontStyle.Bold => 0000 | 00001 = 0001
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frmModal.StartPosition = FormStartPosition.CenterParent;    // 부모창의 정중앙에
            frmModal.ShowDialog();  // 모달창 띄우기
        }

        private void BtnMoaless_Click(object sender, EventArgs e)
        {
            // 부모창의 연계가 없음
            ...
            frmModaless.StartPosition = FormStartPosition.Manual;    // 부모창의 정중앙에 X
